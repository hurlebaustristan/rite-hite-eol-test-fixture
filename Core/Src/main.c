...
static void MX_GPDMA1_Init(void)
{
  ...
  if (HAL_DMAEx_ConfigDataHandling(&handle_GPDMA1_Channel13, &DataHandlingConfig) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_OCTOSPI1_Init(void)
{
  ...
  // Setup external flash in memory mapped mode
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, TOUCH_RST_Pin|LCD_RESET_Pin|DMA_TRANSFER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, VSYNC_FREQ_Pin|RENDER_TIME_Pin|FRAME_RATE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LED_RED_Pin|MCU_ACTIVE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TOUCH_RST_Pin LCD_RESET_Pin */
  GPIO_InitStruct.Pin = TOUCH_RST_Pin|LCD_RESET_Pin;
  ...
  /*Configure GPIO pin : DMA_TRANSFER_Pin */
  GPIO_InitStruct.Pin = DMA_TRANSFER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(DMA_TRANSFER_GPIO_Port, &GPIO_InitStruct);
...
static void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.LimitAddress = 0x60100001;
